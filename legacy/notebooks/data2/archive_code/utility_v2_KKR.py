...
from experiment_dataload_OOP_v4 import DataLoader, list_sheets # to replicate data reader in teh unified code
...
def load_experiment_file(path, measure_sheet=None, index_sheet=None, quicklook=False, save_prefix=None, cumulative=False, mass_only=False, cond_only=False):
    """
    ...
    cumulative : bool, optional
        If True, mass plot is cumulative across vial changes (as in main_code_v4).
    ...
    # Instantiate the OOP loader and load data
