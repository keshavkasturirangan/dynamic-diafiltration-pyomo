...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refresh UnifiedFramework/DATA3/docs/validation/target_validation_status_consolidated.csv")
    parser.add_argument(
        "--consolidated-csv",
        type=Path,
    ...
    parser.add_argument(
        "--tolerance-csv",
        type=Path,
        default=Path("UnifiedFramework/DATA3/docs/validation/tolerance_eval_refresh_20260221.csv"),
