...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--manifest",
        type=Path,
        default=Path("UnifiedFramework/DATA3/docs/validation/nightly/digitized_baselines/manifest.csv"),
    )
    p.add_argument(
        "--thresholds",
        type=Path,
        default=Path("UnifiedFramework/DATA3/docs/validation/nightly/digitized_baselines/thresholds.csv"),
    )
    p.add_argument(
        "--out-csv",
        type=Path,
        default=Path("UnifiedFramework/DATA3/docs/validation/nightly/digitized_baselines/comparison_latest.csv"),
    )
    p.add_argument(
        "--fail-on-fail",
        action="store_true",
