...
- `UnifiedFramework/DATA3/scripts/validation/nightly/nightly_validation_gate.py`
- `UnifiedFramework/DATA3/scripts/validation/nightly/compare_digitized_baselines.py`
- `UnifiedFramework/DATA3/scripts/validation/nightly/append_nightly_note.py`
- `UnifiedFramework/DATA3/scripts/validation/nightly/build_nightly_ops_deck.py` (regenerates the slide deck)
