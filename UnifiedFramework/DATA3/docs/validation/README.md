...
- `paper_profile_parity_checklist.md`: explicit checklist of what DATA1/DATA2 paper-workflow behavior is already represented in unified code and what parity gaps still remain.
