from experiment_dataload_OOP_v14_simpler_plotfix import (
    load_experiment_easy, build_diafiltration_model,
    ModelOptions, ParameterGuess, ExperimentMode, RunMode, BForm
)
import numpy as np

exp, (ok, issues) = load_experiment_easy("NF270_MC2.xlsx", selector="Experiment_3", plot=True)
...
from experiment_dataload_OOP_v14_simpler_plotfix import load_experiment_easy
