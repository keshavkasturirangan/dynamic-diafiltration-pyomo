...
|---|---|---|---|---|---|
| D1-M-F2 | Fig. 2 (all four plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_fig2_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-M-T1 | Table 1 | Table | DATA1 | `results/reproduction/<run_id>/tables/data1_table1_side_by_side.csv` | FAIL [numeric run: 20260221-refresh] (artifact: Preliminary FAIL (`20260218-185741`)) |
| D1-M-F3 | Fig. 3 | Figure | DATA1 | `results/reproduction/<run_id>/figures/data1_fig3_model_overlay.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-M-T2 | Table 2 | Table | DATA1 | `results/reproduction/<run_id>/tables/data1_table2_side_by_side.csv` | MISSING_VALUE (artifact: Preliminary FAIL (`20260218-185741`)) |
| D1-M-F4 | Fig. 4 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_fig4_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-M-F5 | Fig. 5 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_fig5_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-M-F6 | Fig. 6 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_fig6_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |

## DATA1 SI targets

| Target ID | Paper item | Artifact type | Dataset scope | Unified artifact output (planned) | Status |
|---|---|---|---|---|---|
| D1-S-FS2 | Fig. S2 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_si_figS2_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-S-FS3 | Fig. S3 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_si_figS3_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-S-FS4 | Fig. S4 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_si_figS4_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-S-FS5 | Fig. S5 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_si_figS5_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-S-FS6 | Fig. S6 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_si_figS6_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
| D1-S-FS7 | Fig. S7 (all plots) | Figure set | DATA1 | `results/reproduction/<run_id>/figures/data1_si_figS7_*.png` | MISSING_VALUE (artifact: Locked (`20260221-data1-notebook`)) |
