...
- Main paper extraction: `results/reproduction/20260306-023356-paper-pdf-extract/pdf_extract/data2_main/`
- SI extraction: `results/reproduction/20260306-023356-paper-pdf-extract/pdf_extract/data2_si/`
- Target page index: `docs/validation/target_pdf_page_index.csv`
...
| D2-M-T3 | Table 3 | 11 | Baseline side-by-side extracted (`results/reproduction/20260306-mainpaper-table-baseline/tables/data2_table3_side_by_side.csv`), WARNING: unified values missing |
| D2-M-T4 | Table 4 | 12 | Baseline side-by-side extracted (`results/reproduction/20260306-mainpaper-table-baseline/tables/data2_table4_side_by_side.csv`), WARNING: unified values missing |
| D2-M-T5 | Table 5 | 14 | Baseline side-by-side extracted (`results/reproduction/20260306-mainpaper-table-baseline/tables/data2_table5_side_by_side.csv`), WARNING: unified values missing |
| D2-M-T6 | Table 6 | 14,15 | Baseline side-by-side extracted (`results/reproduction/20260306-mainpaper-table-baseline/tables/data2_table6_side_by_side.csv`), WARNING: unified values missing |
